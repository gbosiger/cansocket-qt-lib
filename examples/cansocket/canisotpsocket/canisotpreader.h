...
class CanIsoTpReader : public QObject
{
    Q_OBJECT
public:
    explicit CanIsoTpReader(CanIsoTpSocket *canIsoTpSocket, QCoreApplication *coreApplication);
...
private:
    ...
    CanIsoTpSocket *m_canIsoTpSocket;
