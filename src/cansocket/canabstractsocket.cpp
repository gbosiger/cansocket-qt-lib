...
/*!
    \class CanAbstractSocket

    \brief The CanAbstractSocket class provieds the base functionality
    common to all CAN socket types.

    \reentrant
    \ingroup cansocket
    \inmodule cansocket-qt-lib

    CanAbstractSocket is the base class for all CAN socket types supporting
...
/*!
 * \brief CanAbstractSocket::CanAbstractSocket
 * \param socketType
 * \param parent
 */
